...
public class QuizStateManager : MonoBehaviour
{
    ...
    {
        Debug.Log("QuizStateManager.LoadQuestion() 호출됨");
        ...
        {
            Debug.Log("QuizStateManager: 퀴즈 종료 조건 충족 - OnQuizFinished 이벤트 발생");
        ...
        else
        {
            ...
            Debug.Log($"QuizStateManager: 다음 질문 로드 - {nextQuestion.QuestionText}");
