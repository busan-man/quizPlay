...
public class AnswerController : MonoBehaviour
{
    ...
    private GameObject instantiateAnswerButton(GameObject prefab, string answer, bool isCorrectAnswer, QuestionEntity question)
    {
        ...
        AnswerButtonController buttonController = answerButton.GetComponent<AnswerButtonController>();
        buttonController.SetIsCorrect(isCorrectAnswer);
        buttonController.SetQuestion(question);
        buttonController.SetAnswerText(answer); // 답변 텍스트 설정
